...
#define SYSID_QSYS_TIMESTAMP 1618677779
...
#define I2C_0_BASE 0x9000
#define I2C_0_SPAN 64
#define I2C_0_END 0x903f
#define I2C_0_IRQ 4
...
/*
 * Macros for device 'pi_data_angle', class 'altera_avalon_pio'
 * The macros are prefixed with 'PI_DATA_ANGLE_'.
 * The prefix is the slave descriptor.
 */
#define PI_DATA_ANGLE_COMPONENT_TYPE altera_avalon_pio
#define PI_DATA_ANGLE_COMPONENT_NAME pi_data_angle
#define PI_DATA_ANGLE_BASE 0x9040
#define PI_DATA_ANGLE_SPAN 16
#define PI_DATA_ANGLE_END 0x904f
#define PI_DATA_ANGLE_BIT_CLEARING_EDGE_REGISTER 0
#define PI_DATA_ANGLE_BIT_MODIFYING_OUTPUT_REGISTER 0
#define PI_DATA_ANGLE_CAPTURE 0
#define PI_DATA_ANGLE_DATA_WIDTH 32
#define PI_DATA_ANGLE_DO_TEST_BENCH_WIRING 0
#define PI_DATA_ANGLE_DRIVEN_SIM_VALUE 0
#define PI_DATA_ANGLE_EDGE_TYPE NONE
#define PI_DATA_ANGLE_FREQ 50000000
#define PI_DATA_ANGLE_HAS_IN 1
#define PI_DATA_ANGLE_HAS_OUT 0
#define PI_DATA_ANGLE_HAS_TRI 0
#define PI_DATA_ANGLE_IRQ_TYPE NONE
#define PI_DATA_ANGLE_RESET_VALUE 0

/*
 * Macros for device 'pi_data_x', class 'altera_avalon_pio'
 * The macros are prefixed with 'PI_DATA_X_'.
 * The prefix is the slave descriptor.
 */
#define PI_DATA_X_COMPONENT_TYPE altera_avalon_pio
#define PI_DATA_X_COMPONENT_NAME pi_data_x
#define PI_DATA_X_BASE 0x9050
#define PI_DATA_X_SPAN 16
#define PI_DATA_X_END 0x905f
#define PI_DATA_X_BIT_CLEARING_EDGE_REGISTER 0
#define PI_DATA_X_BIT_MODIFYING_OUTPUT_REGISTER 0
#define PI_DATA_X_CAPTURE 0
#define PI_DATA_X_DATA_WIDTH 32
#define PI_DATA_X_DO_TEST_BENCH_WIRING 0
#define PI_DATA_X_DRIVEN_SIM_VALUE 0
#define PI_DATA_X_EDGE_TYPE NONE
#define PI_DATA_X_FREQ 50000000
#define PI_DATA_X_HAS_IN 1
#define PI_DATA_X_HAS_OUT 0
#define PI_DATA_X_HAS_TRI 0
#define PI_DATA_X_IRQ_TYPE NONE
#define PI_DATA_X_RESET_VALUE 0

/*
 * Macros for device 'pi_data_y', class 'altera_avalon_pio'
 * The macros are prefixed with 'PI_DATA_Y_'.
 * The prefix is the slave descriptor.
 */
#define PI_DATA_Y_COMPONENT_TYPE altera_avalon_pio
#define PI_DATA_Y_COMPONENT_NAME pi_data_y
#define PI_DATA_Y_BASE 0x9060
#define PI_DATA_Y_SPAN 16
#define PI_DATA_Y_END 0x906f
#define PI_DATA_Y_BIT_CLEARING_EDGE_REGISTER 0
#define PI_DATA_Y_BIT_MODIFYING_OUTPUT_REGISTER 0
#define PI_DATA_Y_CAPTURE 0
#define PI_DATA_Y_DATA_WIDTH 32
#define PI_DATA_Y_DO_TEST_BENCH_WIRING 0
#define PI_DATA_Y_DRIVEN_SIM_VALUE 0
#define PI_DATA_Y_EDGE_TYPE NONE
#define PI_DATA_Y_FREQ 50000000
#define PI_DATA_Y_HAS_IN 1
#define PI_DATA_Y_HAS_OUT 0
#define PI_DATA_Y_HAS_TRI 0
#define PI_DATA_Y_IRQ_TYPE NONE
#define PI_DATA_Y_RESET_VALUE 0
