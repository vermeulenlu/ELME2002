...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/soc_system_LT24_RESET_N.v \
  $QSYS_SIMDIR/submodules/soc_system_LT24_D.v \
  $QSYS_SIMDIR/submodules/soc_system_LT24_ADC_SPI.v \
  $QSYS_SIMDIR/submodules/soc_system_LT24_ADC_BUSY.v \
