...
mkdir -p ./libraries/LT24_RESET_N/
mkdir -p ./libraries/LT24_D/
mkdir -p ./libraries/LT24_ADC_SPI/
mkdir -p ./libraries/LT24_ADC_BUSY/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_LT24_RESET_N.v"                                                -work LT24_RESET_N                             -cdslib ./cds_libs/LT24_RESET_N.cds.lib                            
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_LT24_D.v"                                                      -work LT24_D                                   -cdslib ./cds_libs/LT24_D.cds.lib                                  
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_LT24_ADC_SPI.v"                                                -work LT24_ADC_SPI                             -cdslib ./cds_libs/LT24_ADC_SPI.cds.lib                            
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_LT24_ADC_BUSY.v"                                               -work LT24_ADC_BUSY                            -cdslib ./cds_libs/LT24_ADC_BUSY.cds.lib                           
