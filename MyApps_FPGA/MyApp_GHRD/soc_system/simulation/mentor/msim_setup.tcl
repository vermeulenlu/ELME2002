...
# ----------------------------------------
# ACDS 18.0 614 win32 2018.05.24.22:20:59
...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_LT24_RESET_N.v"                                                                             -work LT24_RESET_N                            
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_LT24_D.v"                                                                                   -work LT24_D                                  
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_LT24_ADC_SPI.v"                                                                             -work LT24_ADC_SPI                            
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_LT24_ADC_BUSY.v"                                                                            -work LT24_ADC_BUSY                           
