	soc_system u0 (
		...
		.clk_hps_external_connection_export       (<connected-to-clk_hps_external_connection_export>),       //       clk_hps_external_connection.export
		...
		.pi_data_angle_external_connection_export (<connected-to-pi_data_angle_external_connection_export>), // pi_data_angle_external_connection.export
		.pi_data_x_external_connection_export     (<connected-to-pi_data_x_external_connection_export>),     //     pi_data_x_external_connection.export
		.pi_data_y_external_connection_export     (<connected-to-pi_data_y_external_connection_export>),     //     pi_data_y_external_connection.export
		...
		.read_external_connection_export          (<connected-to-read_external_connection_export>),          //          read_external_connection.export
		.readdata_rxd_external_connection_export  (<connected-to-readdata_rxd_external_connection_export>),  //  readdata_rxd_external_connection.export
		.reset_reset_n                            (<connected-to-reset_reset_n>),                            //                             reset.reset_n
		.speed_left_external_connection_export    (<connected-to-speed_left_external_connection_export>),    //    speed_left_external_connection.export
		.speed_right_external_connection_export   (<connected-to-speed_right_external_connection_export>),   //   speed_right_external_connection.export
		.write_external_connection_export         (<connected-to-write_external_connection_export>),         //         write_external_connection.export
		.writedata_txd_external_connection_export (<connected-to-writedata_txd_external_connection_export>)  // writedata_txd_external_connection.export
	);
